...
class CPU:
    ...
    def jmp(self, op1, op2=None):
        self.pc = self.reg[op1]

    def jeq(self, op1, op2=None):
        if self.fl == 0b00000001:
            self.jmp(op1)
        else:
            self.pc += 2

    def jne(self, op1, op2=None):
        if self.fl != 0b00000001:
            self.jmp(op1)
        else:
            self.pc += 2
    ...
    def ld(self, op1, op2):
        self.reg[op1] = self.ram_read(self.reg[op2])
        self.pc += 3

    def st(self, op1, op2):
        self.ram_write(self.reg[op2], self.reg[op1])
        self.pc += 3
